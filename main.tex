...
\fancyfoot[L]{\scriptsize  Báo cáo Đồ án Tốt nghiệp (COa4paper,
		total={160mm,240mm},  % fix over page
		left=30mm,
		top=10mm,
	}
...
\fancyhead[R]{
	...
	\end{tabular}  }
\fancyfoot{} % clear all footer fields
\fancyfoot[L]{\scriptsize  Báo cáo Đồ án Tốt nghiệp Khoa Khoa học Máy tính (CO4337) - HK2 2025 - 2026}
...
\newcommand*\l@subsubsubsection{%
  \@dottedtocline{4}{10em}{4em}
}
...
\\
\\
{\fontsize{25}{34}\selectfont\textbf{CHƯƠNG TRÌNH HỖ TRỢ}} \\[1em]
{\fontsize{25}{34}\selectfont\textbf{DẠY VÀ HỌC MÔN VẬT LÝ LỚP 11}}
\\
\\
\\ \vspace{0.5cm} {\LARGE \textbf{NGÀNH: KHOA HỌC MÁY TÍNH}}
\end{tabular}
\end{center}
\vspace{0.5cm}
\begin{table}[h]
\begin{tabular}{rll}
\hspace{6 cm} &  \textbf{\Large HỘI ĐỒNG:} {\Large TS. Nguyễn Đức Dũng}
\\
\\
\hspace{6 cm} &   \textbf{\Large GVHD:}\quad {\Large ThS. Trần Giang Sơn}

\\
\\
\hspace{6 cm}  &   \textbf{\Large TKHĐ:} {\Large ThS. Mai Đức Trung}
\\
\\
...
\\
\\
\hspace{6 cm}&   \textbf{\Large SVTH2:}  {\Large Mai Hoàng Huynh (2211314)}
\\
\\
\hspace{6 cm} &   \textbf{\Large SVTH3:}  {\Large Nguyễn Tuấn Khanh (2211491)}
\\
\\
\end{tabular}
\end{table}
...
\newpage
\input{Contents/TongQuanVaGiaiPhapHienCo}
\newpage
...
\newpage
\input{Contents/XayDungHeThongMoPhong}
\newpage
\input{Contents/KiemThuVaDanhGia}
\newpage
